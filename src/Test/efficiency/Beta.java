    ...
    public void run() {
        ...
        for (int d = 0; d < 5; d++) {
                    ...
                    for (int number = 0; number < 30; number++)
                    {
                        ...
                        for (int e = 0; e < CanTrans.size(); e++) {
                            ...
                            if (temp.matchingPaths_low == 0) {
                                ...
                                temp.low = (1 - Parameter.Beta) * Math.atan(temp.matches_low.size()) * 2
                                        / Math.PI + Parameter.Beta * temp.sumOfTrust_low / temp.matchingPaths_low;
                            }
            ...
            try {
                ...
                FileWriter writer = new FileWriter("D:\\Users\\shiqun\\Desktop\\效率\\" + d + "\\Beta" + "_MTK" + ".txt");
