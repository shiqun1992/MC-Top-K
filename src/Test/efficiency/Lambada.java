        ...
        for(int d =0;d<5;d++)
        {
            ...
            for(int q = 0;q<5;q++)
            {
                ...
                for(int i = 0;i<4;i++)
                {
                    ...
                    {
                        //设置参数;
                        Parameter.LambadaT = _NaMuTa[i][0];
                        Parameter.LambadaR = _NaMuTa[i][1];
                        Parameter.LambadaRho = _NaMuTa[i][2];
...
//                        for (int h = 0; h < heapMin.Heap.size(); h++)
//                        {
//                            System.out.print(heapMin.Heap.get(h).dataVNode.nodeID + " ");
//                            System.out.println(heapMin.Heap.get(h).low);
//                        }
                        ...
                        if(duration<time_z)
                            time_z = duration / 1000;
                        //System.out.println("查找时间：" + time_z);
                    }
            ...
            try
            {
                ...
                FileWriter writer = new FileWriter("D:\\Users\\shiqun\\Desktop\\效率\\"+d+"\\Lambada"+"_MTK"+".txt");
